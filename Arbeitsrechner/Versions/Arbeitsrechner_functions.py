...
bd_time = input("Deine zusaetzliche Pause\t(bsp. 00:15):\n\t")
...
def calculate_over_hours:
    ...
    print("System:\t Error Zeitberechnung: Keine Berechnung stattgefunden ~~ Zeile: 100")

calculate_over_hours()
